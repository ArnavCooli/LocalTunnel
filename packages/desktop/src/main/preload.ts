...
const api = {
  ...
  gateway: {
    ...
    test: (details: Record<string, string>) => ipcRenderer.invoke('gateway:test', details),
    probe: (target: Record<string, string>) => ipcRenderer.invoke('gateway:probe', target),
    adopt: (target: Record<string, string>) => ipcRenderer.invoke('gateway:adopt', target),
